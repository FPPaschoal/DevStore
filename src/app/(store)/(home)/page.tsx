  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
      ...
      >
        ...
        />
        <div className="absolute bottom-28 right-28 h-12 flex items-center gap-2 max-2-[280px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
      ...
      >
        <Image
          ...
          className="group-hover:scale-105 transition-transform duration-500 ease-in-out"
        />
        <div className="absolute bottom-10 right-10 h-12 flex items-center gap-2 max-2-[280px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
          <span className="text-sm truncate">Moletom AI Side</span>
          <span className="flex h-full items-center justify-center rounded-full bg-violet-500 px-4">
            R$129
          </span>
